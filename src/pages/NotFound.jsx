  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-16 relative overflow-hidden">
      ...
      <div className="max-w-2xl mx-auto text-center relative z-10">
        ...
        >
          <h1 className="text-8xl md:text-9xl font-light text-transparent bg-gradient-to-b from-gray-200 via-gray-300 to-gray-400 bg-clip-text select-none font-montserrat leading-none">
            404
          </h1>
          
          {/* Subtle glow effect */}
          <div className="absolute inset-0 text-8xl md:text-9xl font-light text-primary/5 blur-sm font-montserrat leading-none">
            404
          </div>
        </motion.div>
