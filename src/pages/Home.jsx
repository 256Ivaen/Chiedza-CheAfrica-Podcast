...
const Home = () => {
  ...
  const structuredData = {
    ...
    description:
      "Chiedza CheAfrica Podcast - Lighting paths. Inspiring minds. Amplifying African stories through conversations on aviation, STEM, disability inclusion, and mental health.",
    foundingDate: "2023",
    address: {
      "@type": "PostalAddress",
  ...
  return (
    <>
      <Helmet>
        <title>
          Chiedza CheAfrica Podcast | Amplifying African Stories of Innovation &
          Impact
        </title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="Chiedza CheAfrica Podcast | African Stories of Innovation & Inspiration"
        />
        <meta
          property="og:description"
          content="Lighting paths. Inspiring minds. Amplifying African stories. Listen to changemakers shaping Africa's future in aviation, STEM, disability inclusion and mental health."
        />
        <meta
          property="og:image"
          content="https://chiedzacheafrica.com/assets/images/chiedza-hero.jpg"
        />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta
          property="og:image:alt"
          content="Chiedza CheAfrica Podcast - Lighting Africa's Path"
        />
        ...
        <meta
          name="twitter:title"
          content="Chiedza CheAfrica Podcast | Amplifying African Stories"
        />
        <meta
          name="twitter:description"
          content="Lighting paths. Inspiring minds. Amplifying African stories of innovation, courage and purpose."
        />
        <meta
          name="twitter:image"
          content="https://chiedzacheafrica.com/assets/images/chiedza-hero.jpg"
        ...
        <meta
          ...
          content="Chiedza CheAfrica Podcast - Stories of Innovation, Inspiration & Impact"
        />
        ...
        <meta
          property="og:audio"
          content="https://chiedzacheafrica.com/assets/audio/trailer.mp3"
        />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            name: "Chiedza CheAfrica Podcast",
            description:
              "A global podcast and movement celebrating Africa's ascent through stories of courage, innovation, and purpose. Spotlighting changemakers across aviation, STEM, disability inclusion, mental health, and community empowerment.",
            url: "https://chiedzacheafrica.com",
            image:
              "https://chiedzacheafrica.com/assets/images/podcast-cover.jpg",
            ...
            keywords:
              "Africa podcast, African innovation, aviation, STEM, disability inclusion, mental health, youth empowerment",
          })}
        </script>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            name: "Chiedza CheAfrica Podcast",
            description:
              "Lighting paths. Inspiring minds. Amplifying African stories through podcast episodes featuring changemakers across various fields.",
            publisher: {
              "@type": "Organization",
              name: "Chiedza CheAfrica",
              url: "https://chiedzacheafrica.com",
      ...
      <main className="overflow-hidden">
        ...
        {!loadingEpisodes && episodes.length > 0 && (
          <section
            ...
            aria-label="Featured Podcast Episodes"
          >
