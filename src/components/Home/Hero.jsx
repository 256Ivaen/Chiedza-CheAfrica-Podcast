        ...
        <div className="px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
          ...
          >
            ...
            >
              ...
              <span className="inline-flex items-baseline">
                <FlipWords 
                  ...
                  duration={2000} 
                />
                <span className="inline-block align-baseline ml-1">{heroData.titleSuffix}</span>
              </span>
            </motion.h1>
            ...
            <motion.div 
              ...
              variants={fadeVariants}
            >
              <p className="text-white text-sm font-light">Available on all major platforms:</p>
                ...
                {streamingPlatforms.map((platform, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="text-sm font-light">{platform.name}</span>
                    </motion.a>
                  );
                })}
              </div>
